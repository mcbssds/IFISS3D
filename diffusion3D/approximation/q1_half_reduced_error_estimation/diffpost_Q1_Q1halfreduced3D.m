...
ae(:,1,7)  = ael(:,1,3,7) + ael(:,2,4,8) + ael(:,3,1,5) + ael(:,4,2,6);  %added missing connection
...
ae(:,3,5) = ael(:,5,7,2) + ael(:,6,8,1);                                    % added missing connection
ae(:,3,6) = ael(:,8,6,3) + ael(:,7,5,4);                                    % added missing connection
...
ae(:,4,5) = ael(:,1,8,6) + ael(:,5,2,4);                                   %added missing connection
