% DIFF3D_TESTPROBLEM (for linux/MacOS users) driver for 3D test problem setup
...
%
if sn==1
system('/bin/cp ./diffusion3D/test_problems/unit_rhs3D.m ./diffusion3D/specific_rhs3D.m');
...
elseif sn == 11
system('/bin/cp ./diffusion3D/test_problems/zero_rhs3D.m ./diffusion3D/specific_rhs3D.m');
system('/bin/cp ./diffusion3D/test_problems/trilinear_bc.m ./diffusion3D/specific_bc3D.m');
cube_diff
...
elseif sn == 12
system('/bin/cp ./diffusion3D/test_problems/triquadratic_rhs.m ./diffusion3D/specific_rhs3D.m');
system('/bin/cp ./diffusion3D/test_problems/zero_bc3D.m ./diffusion3D/specific_bc3D.m');
cube_diff
...
elseif sn == 13
system('/bin/cp ./diffusion3D/test_problems/tricubic_rhs.m ./diffusion3D/specific_rhs3D.m');
system('/bin/cp ./diffusion3D/test_problems/zero_bc3D.m ./diffusion3D/specific_bc3D.m');
cube_diff
energy_norm_squared_approx = x_it'*A*x_it;
fprintf('energy norm squared of approximation is %4.4f\n', energy_norm_squared_approx);
