...
%
% recompute the full Q2 matrices
...
for igpt = 1:nngpt
    ...
    aez = aez + wght*(dpsidx_v(:,9:27).*permute(dpsidx_v(:,9:27),[1 3 2]) + dpsidy_v(:,9:27).*permute(dpsidy_v(:,9:27),[1,3,2])....
